<?php
    ...
    if (!empty($_GET['home'])) { 
        ...
        $_GET = $_SESSION = $_COOKIE = $month = $year = null;
        session_destroy();
    }
    ...
    $layout = (isset($_SESSION['layout'])) ? 'show' : 'hide';
        ...
        <table class="table table-dark">
            ...
            <div class="d-flex justify-content-end align-items-center">
                ...
                <form class="col-1 d-flex pr-0 justify-content-end" action="index.php" method="get">
                    ...
                    <!-- <input type="submit" name="month" value="<?= $month + 1 ;?>"/><span class="prev-m mr-3 py-2 px-2">&#x25B2;</span> -->
