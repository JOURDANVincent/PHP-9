<?php
    ...
    if (!empty($_GET['year']) AND !empty($_GET['month'])) {
        ...
        $year = $_SESSION['year'] = intval($_GET['year']);
        $month  = $_SESSION['month'] = intval($_GET['month']); 
    ...
    if ($layout == 'show') {
        ...
        foreach($calendar as $type => $value) {
            ...
            foreach($calendar[$type]->array as $key => $value) {  // recherche dans tableau birthday
                ...
                if ($month == $searchInCalendar[1] AND $year == $searchInCalendar[2]) {
    
                    $dataBackground[$searchInCalendar[0]] = $calendar[$type]->color;
...
<body>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            ?>
            <div class="col-12">
                <h1 class="mb-4 mt-5">Partie 9 - TP</h1>
                <h2>Exercice TP :</h2>
                <p>
            ...
            <div class="col-6 mt-5">
                ...
                <form action="index.php" method="get">
                    ...
                    <select class="form-control mb-3" name="month" id="monthSelect">
                        <?php
                    ...
                    <select class="form-control mb-3" name="year" id="yearSelect">
                        <?php
                            for($a = 1970; $a <= 2030; $a++) {
                                echo '<option value="' . $a . '"> année ' . $a . '</option>';
                            }
                        ?>
                    </select>

                    <div class="text-center">
                        <input type="submit" class="btn btn-dark px-5" value="OPEN CALENDAR">
                    </div>
            ...
            <div class="col-10">
                <h3 class="mt-3 pl-2"><a class="text-white" data-toggle="collapse" title="clic pour afficher les informations"  href="#collapseInfo" role="button" aria-expanded="true" aria-controls="collapseInfo">Informations</a></h3>
                <div id="collapseInfo" class="pl-4">
            ...
            <div class="col-2">
                <a href="index.php?home=reset"><img id="home" title="RESET du calendrier" class="img-fluid" src="assets/img/svg/home.svg" alt="bouton retour page d'accueil"></a>
            </div>
            ...
            <div class="d-flex justify-content-end align-items-center">
                <div class="col-5 d-flex">
                    <form class="justify-content-between" action="#" method='get'>
                        ...
                        <select class="form-control selectNewDate" name="year" id="yearSelect">
                            <?php
                                for($a = 1970; $a <= 2030; $a++) {
                                    echo '<option value="' . $a . '"> année ' . $a . '</option>';
                                }
                ...
                <h4 class="calendarTitle col-6 ml-3 mb-3 text-center"><?php echo $arrayMonth[$month - 1] . ' ' . $year; ?></h4>
                    ...
                    foreach($arraychunk as $modulo7 => $week) { // boucle ligne calendrier
                        ...
                        foreach($arraychunk[$modulo7] as $day => $data) { // boucle cellule calendrier  data-toggle="modal" data-target="#eventModal"
                            ...
                            if ($data == null) {
                                ...
                                if (isset($dataBackground[$data]) ) {
                                    $class = $dataBackground[$data];
                                    echo '<td class="'.$class.'" >'.$data.'</td>';
                                    
                                    // ajout d'un input hidden pour récupérer la description
        ...
        <div class="row">
            <div class="col-12 text-left mb-5">
                ...
                <form class="bgEventForm bdc py-3 px-5" action="index.php" post="get">
                    <div class="eventSelect pl-2 mb-3 txt2">aucun événement pour le moment..</div>
                    <input class="hiddenEvent form-control mb-2" type="hidden" name="newEventDay" value="">
                    <select class="selectEvent form-control mb-2" name="newEventType" id="" value="">
                        <option class="bgOption" value="birthday">Date de Naissance</option>
